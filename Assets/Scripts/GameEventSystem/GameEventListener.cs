...
//                              gameObject.name);
        ...
        public class EventAndResponse {
            ...
            public ResponseWithScriptableObject responseForSentScriptableObject;
            ...
            public void EventRaised() {
                ...
                // ScriptableObject
                if (responseForSentScriptableObject.GetPersistentEventCount() >= 1) {
                    responseForSentScriptableObject.Invoke(gameEvent.sentScriptableObject);
                }
            }
        }
    }
    ...
    [Serializable]
    public class ResponseWithScriptableObject : UnityEvent<ScriptableObject> { }
}